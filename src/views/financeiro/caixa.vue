    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="80px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="Entrada" prop="entrada">
          <money v-model="temp.entrada" v-bind="money" class="el-input__inner" />
        </el-form-item>

        <el-form-item label="Saída" prop="saida">
          <money v-model="temp.saida" v-bind="money" class="el-input__inner" />
        </el-form-item>

        <el-form-item label="Saldo" prop="saldo">
          <money v-model="temp.saldo" v-bind="money" class="el-input__inner" />
        </el-form-item>
      </el-form>
