<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.nome" placeholder="Nome" style="width: 300px;" class="filter-item" clearable @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.doc" placeholder="Doc" style="width: 250px;" class="filter-item" clearable @keyup.enter.native="handleFilter" />
